/*
 ...
 \ Programa: P00303F9.PRG
 \ Data....: 08-01-96
 \ Sistema.: Triton - Controle Imobili rio
 \ Funcao..: Lan‡amento em RECIBO->luz, gerado por TRI_P003
...
Set Filter To ((OUTDES->tipdes=3).and.(Month(OUTDES->dtvenc)=M->mes)).and.OUTDES->pasta=ALUGUEL->pasta
DBGOTOP()
Do While !Eof()
